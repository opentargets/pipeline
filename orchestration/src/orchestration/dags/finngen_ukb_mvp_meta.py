...
SOURCE_CONFIG_FILE_PATH = Path(__file__).parent / 'config' / 'finngen_ukb_mvp_meta.yaml'
...
with DAG(
    ...
    description='Gentropy Pipeline — Ingest FinnGen UK Biobank MVP meta-analysis ingestion pipeline',
