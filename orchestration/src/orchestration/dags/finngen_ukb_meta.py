"""Airflow DAG to ingest and harmonize FinnGen UKB two-way meta-analysis data."""
...
SOURCE_CONFIG_FILE_PATH = Path(__file__).parent / 'config' / 'finngen_ukb_meta.yaml'
...
with DAG(
    ...
    description='Gentropy Pipeline — Ingest FinnGen UK Biobank two-way meta-analysis ingestion pipeline',
