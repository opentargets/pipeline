...
with DAG(
    ...
    def gentropy_step_differs(step_name: str) -> list[Differ]:
        gentropy_step_outputs: dict[str, dict[str, Any]] = {
            ...
            'gentropy_pathway_ingestion': {
                'step.pathway_index_path': gsp('gentropy_pathway_ingestion', 'step.pathway_index_path'),
                'step.pathway_enrichment_path': gsp('gentropy_pathway_ingestion', 'step.pathway_enrichment_path'),
            },
