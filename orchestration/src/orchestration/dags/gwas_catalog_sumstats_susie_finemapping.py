"""Airflow DAG that uses Google Cloud Batch to run the SuSiE Finemapper step for GWAS Catalog sumstats."""
...
SOURCE_CONFIG_FILE_PATH = Path(__file__).parent / 'config' / 'gwas_catalog_sumstats_susie_finemapping.yaml'
...
with DAG(
    ...
    description='Open Targets Genetics — Susie Finemap GWAS Catalog summary statistics',
