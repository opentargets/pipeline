...
gs://gwas_catalog_sumstats_susie/heritability_estimates/
```
...
The heritability estimates are generated by running LDSC (LD Score Regression) on the harmonised summary statistics. The results are stored in `gs://gwas_catalog_sumstats_susie/heritability_estimates/` directory.

Data is produced by the **gwas_catalog_heritability_estimate DAG**. The dag configuration can be found in `gwas_catalog_heritability_estimate.yaml` file under the config directory. The dag runs entirely on Google Batch with no Dataproc stage.

DAG contains 1 step:

1. heritability_estimate
...
- [chore: 2026/05 GWAS Catalog data sync](https://github.com/opentargets/issues/issues/4331)
- [chore: 2026/05 GWAS Catalog harmonisation](https://github.com/opentargets/issues/issues/4334)
- [chore: 2026/05 GWAS Catalog manual curation update](https://github.com/opentargets/issues/issues/4333)
- [chore: 2026/05 GCCA & GCSS pics run](https://github.com/opentargets/issues/issues/4336)
