...
class PlatformOutputMetadata(Metadata):
    ...
    CITE_AS = """@article{PMID:39657122,
        ...
        pages = {D1467--D1475},
        month = jan,
        affiliation = {Open Targets, Wellcome Genome Campus, Hinxton, Cambridgeshire CB10 1SD, UK.},
        doi = {10.1093/nar/gkae1128},
        pmid = {39657122},
        pmcid = {PMC11701534},
        date-added = {2024-12-16T14:58:07GMT},
        date-modified = {2025-02-13T11:33:43GMT},
        ...
        url = {http://eutils.ncbi.nlm.nih.gov/entrez/eutils/elink.fcgi?dbfrom=pubmed&id=39657122&retmode=ref&cmd=prlinks},
    }
    """
